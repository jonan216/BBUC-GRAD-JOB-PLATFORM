    ...
    <div className="flex min-h-screen items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-lg border bg-card p-6">
          <h1 className="font-display text-xl font-bold tracking-tight mb-1">Graduate Login</h1>
          <p className="text-sm text-muted-foreground mb-6">Sign in to your graduate account</p>
